...
#define MOTOR_NSLEEP_PORT    GPIOA
#define MOTOR_NFAULT_PIN     GPIO_PIN_11
#define MOTOR_NFAULT_PORT    GPIOA

// PWM Timer Configuration
#define MOTOR_PWM_TIM        TIM1
#define MOTOR_PWM_CHANNEL1   TIM_CHANNEL_1  // IN1
#define MOTOR_PWM_CHANNEL2   TIM_CHANNEL_2  // IN2
#define MOTOR_PWM_FREQ       50000          // frequency (is the current fine??)
